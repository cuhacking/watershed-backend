...
const REQUIRED_FIELDS = ['firstName', 'lastName', 'studyLevel', 'school', 'hackathonNumber', 'eventsNumber', 'skills', 'resumePath', 'question1', 'question2', 'question3', 'willingToInterview'];
